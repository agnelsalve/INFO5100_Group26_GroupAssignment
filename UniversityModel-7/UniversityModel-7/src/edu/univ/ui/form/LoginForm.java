...
/** 
 * Auto-generated editable GUI wrapper for edu.univ.ui.LoginPanel.
 * You can open this file in NetBeans Design tab and modify layout safely.
 * It embeds the existing edu.univ.ui.LoginPanel as a custom component so you keep functionality.
 */
public class LoginForm extends javax.swing.JPanel {

    private edu.univ.ui.LoginPanel embedded;

    public LoginForm() {
        initComponents();
        // Create and add the original panel as a custom component
        embedded = new edu.univ.ui.LoginPanel();
