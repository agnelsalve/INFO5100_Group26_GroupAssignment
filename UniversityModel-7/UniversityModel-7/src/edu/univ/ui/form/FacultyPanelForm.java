...
/** 
 * Auto-generated editable GUI wrapper for edu.univ.ui.FacultyPanel.
 * You can open this file in NetBeans Design tab and modify layout safely.
 * It embeds the existing edu.univ.ui.FacultyPanel as a custom component so you keep functionality.
 */
public class FacultyPanelForm extends javax.swing.JPanel {

    private edu.univ.ui.FacultyPanel embedded;

    public FacultyPanelForm() {
        initComponents();
        // Create and add the original panel as a custom component
        embedded = new edu.univ.ui.FacultyPanel();
    ...
    private void initComponents() {
        ...
        header.setText("FacultyPanelForm");
