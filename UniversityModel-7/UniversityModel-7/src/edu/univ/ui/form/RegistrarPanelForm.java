...
/** 
 * Auto-generated editable GUI wrapper for edu.univ.ui.RegistrarPanel.
 * You can open this file in NetBeans Design tab and modify layout safely.
 * It embeds the existing edu.univ.ui.RegistrarPanel as a custom component so you keep functionality.
 */
public class RegistrarPanelForm extends javax.swing.JPanel {

    private edu.univ.ui.RegistrarPanel embedded;

    public RegistrarPanelForm() {
        initComponents();
        // Create and add the original panel as a custom component
        embedded = new edu.univ.ui.RegistrarPanel();
    ...
    private void initComponents() {
        ...
        header.setText("RegistrarPanelForm");
