...
/** 
 * Auto-generated editable GUI wrapper for edu.univ.ui.StudentPanel.
 * You can open this file in NetBeans Design tab and modify layout safely.
 * It embeds the existing edu.univ.ui.StudentPanel as a custom component so you keep functionality.
 */
public class StudentPanelForm extends javax.swing.JPanel {

    private edu.univ.ui.StudentPanel embedded;

    public StudentPanelForm() {
        initComponents();
        // Create and add the original panel as a custom component
        embedded = new edu.univ.ui.StudentPanel();
    ...
    private void initComponents() {
        ...
        header.setText("StudentPanelForm");
